...
<ul id="main-menu" class="" >
	...
	<li id="health_status"><a href="new_health_status.php"><i class="entypo-user-add"></i><span>Seguimiento Deportivo</span></a> 	
	...
	<li class="" id="routinehassubopen"><a href="#" onclick="memberExpand(4)"><i class="entypo-alert"></i><span>Gastos</span></a>
